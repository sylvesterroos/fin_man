defmodule FinManWeb.Components.Divider do
  @moduledoc """
  The `FinManWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/divider
  ...
  @doc """
  `FinManWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
