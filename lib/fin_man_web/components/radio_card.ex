defmodule FinManWeb.Components.RadioCard do
  @moduledoc """
  The `FinManWeb.Components.RadioCard` module provides a customizable radio card component for Phoenix LiveView
