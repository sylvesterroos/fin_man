defmodule FinManWeb.Components.Menu do
  @moduledoc """
  The `FinManWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `FinManWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import FinManWeb.Components.Button, only: [button_link: 1]
