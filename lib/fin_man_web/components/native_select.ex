defmodule FinManWeb.Components.NativeSelect do
  @moduledoc """
  The `FinManWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `FinManWeb.Components.NativeSelect`
