defmodule FinManWeb.Components.Alert do
  @moduledoc """
  FinManWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
