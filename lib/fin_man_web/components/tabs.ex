defmodule FinManWeb.Components.Tabs do
  @moduledoc """
  `FinManWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import FinManWeb.Components.Badge, only: [badge: 1]
