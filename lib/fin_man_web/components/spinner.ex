defmodule FinManWeb.Components.Spinner do
  @moduledoc """
  The `FinManWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `FinManWeb.Components.Spinner` module enables developers to provide
