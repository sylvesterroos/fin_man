defmodule FinManWeb.Components.ScrollArea do
  @moduledoc """
  The `FinManWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
