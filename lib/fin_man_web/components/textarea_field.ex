defmodule FinManWeb.Components.TextareaField do
  @moduledoc """
  The `FinManWeb.Components.TextareaField` module provides a versatile and customizable textarea field component
