defmodule FinManWeb.Components.Overlay do
  @moduledoc """
  The `FinManWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `FinManWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
