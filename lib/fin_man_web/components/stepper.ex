defmodule FinManWeb.Components.Stepper do
  @moduledoc """
  The `FinManWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `FinManWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/stepper
  ...
  use Gettext, backend: FinManWeb.Gettext
