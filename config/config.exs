...
config :ex_cldr, default_backend: FinMan.Cldr
...
config :fin_man, FinManWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: FinManWeb.ErrorHTML, json: FinManWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: FinMan.PubSub,
  live_view: [signing_salt: "zgbrsn5s"]
