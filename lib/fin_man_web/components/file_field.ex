defmodule FinManWeb.Components.FileField do
  @moduledoc """
  The `FinManWeb.Components.FileField` module provides a versatile and customizable component
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/file-field
  ...
  import FinManWeb.Components.Progress, only: [progress: 1]
