defmodule FinManWeb.Components.CheckboxCard do
  @moduledoc """
  The `FinManWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
