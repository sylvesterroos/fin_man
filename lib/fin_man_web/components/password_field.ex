defmodule FinManWeb.Components.PasswordField do
  @moduledoc """
  The `FinManWeb.Components.PasswordField` module is a Phoenix component designed to render a customizable
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/password-field
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      ...
      Gettext.dgettext(FinManWeb.Components.PasswordField.Gettext, "errors", msg, opts)
    end
  end
end
