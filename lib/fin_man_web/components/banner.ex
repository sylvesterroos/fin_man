defmodule FinManWeb.Components.Banner do
  @moduledoc """
  FinManWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
