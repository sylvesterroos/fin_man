defmodule FinManWeb.Components.Combobox do
  @moduledoc """
  The `FinManWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
